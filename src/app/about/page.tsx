        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/products"
                className="inline-flex items-center gap-2 bg-navy text-white font-heading font-bold px-8 py-3.5 rounded text-sm uppercase tracking-[0.06em] hover:bg-blue transition-colors"
              >
                View All Products
              </Link>
            </div>
